...
function calculateTip(bill,tip){
    var conversion = parseFloat(tip)/100;
    console.log(conversion);
    return bill * conversion;
}
 ...
 */
 var userTip = prompt('Enter tip percentage');
 var userBill = prompt('Enter bill total.');
 alert(calculateTip(userBill, userTip));
...
function applyDiscount(price, discount){
    var secondConversion = parseFloat(discount)/100;
